...
public class ShipDaoImp implements Shipdao{
    ...
    public void createShipTable() {
        ...
        try {
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS ship(id int primary key unique auto_increment," +
                    "berth_number varchar(60), bollard_number varchar(60), name varchar(60), ETA varchar(60), ETD varchar(60), " +
    ...
    public void insert(Ship ship) {
        ...
        try {
            ...
            preparedStatement.setString(4, ship.getETA());
            preparedStatement.setString(5, ship.getETD());
    ...
    public Ship selectById(int id) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                ship.setETA(resultSet.getString("ETA"));
                ship.setETD(resultSet.getString("ETD"));
    ...
    @Override
    public List<Ship> selectByDate(String year, String month, String day, String hour, String minute, String second) {
        List <Ship> ships = new ArrayList<>();
        Connection connection = null;
        PreparedStatement preparedStatement = null;
        ResultSet resultSet = null;
        ...
        try {
            ...
            preparedStatement.setString(6, second);
            resultSet = preparedStatement.executeQuery();
